...
open class SelectorRow<Cell: CellType, VCType: TypedRowControllerType where Cell: BaseCell, VCType: UIViewController, VCType.RowValue == Cell.Value>: OptionsRow<Cell>, PresenterRowType {
